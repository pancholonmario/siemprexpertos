...
<div class="row">
  <h4 align="center">Estamos en la búsqueda de Profesionales y expertos relacionados a eventos..</h4><br><br>

  <div class="col-md-12" align="center">
    <h5>Contáctanos y envíanos tu hoja de vida:  <a href="mailto:pancho7mar@gmail.com">siemprexpertos@gmail.com</a></h5><br><br>
    <a href="mailto:pancho7mar@gmail.com"> <img src="http://emunah.co/wp-content/uploads/2016/07/portada_icon_cv1.png" alt=""></a><br><br>
      <a href="/eventos">Regresar a la página anterior</a><br>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 mx-auto">
        <h2>Quieres formar parte de nosotros:</h2><br><br>
        <center>
        <img src="https://lamenteesmaravillosa.com/wp-content/uploads/2016/10/mujer-haciendo-una-entrevista-de-trabajo.jpg" with="250" height="250" alt="">
      </center><br><br>
<div class="row" align="center">
        ...
        <div class="col-sm-4" align="center">
          <h5>Eres Dj</h5>
            <h5>Eres Fotógrafo</h5>

</div>
        <div class="col-sm-8" align="center">
  <h5>Eres Animador Infantil</h5>
  <h5>Eres Mesero</h5>
            ...
            <a align="center" href="https://m.me/100004617675699"> <h6>Envíanos un mensaje en Facebook <i class="fa fa-facebook-f"></i></h6>
            </a><br><br><br>
            <p>Envíanos tu CV: siemprexpertos@gmail.com <i class="fa fa-sign-in" style="font-size:24px"></i> Analizaremos tu perfil</p>
      </div>
    </div>
  </div>
</section>
